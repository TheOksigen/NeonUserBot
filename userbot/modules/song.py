...
CmdHelp('song').add_command(
    'deez',
    '<mahnı adı/youtube/spotify/soundcloud>',
    'Bir neçə saytdan mahnını axtarıb, mahnını yükləyər.').add_command(
        'song',
        '<mahnı adı/youtube/spotify>',
        'Mahnını yükləyər.').add_command(
            'songpl',
            '<spotify playlist>',
    'Spotify Playlist\'indən mahnı yüklayər').add()
