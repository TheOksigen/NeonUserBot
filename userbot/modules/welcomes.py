...
CmdHelp('welcome').add_command(
    'setwelcome və ya .xosgeldin', '<qarşılama mesajı>', 'Mesajı söhbətə qarşılama mesajı olaraq qeyd edər.'
).add_command(
    'checkwelcome və ya .yoxlaxg', None, 'Söhbətdə qarşılama mesajı varmı deyə yoxlayar.'
).add_command(
    'rmwelcome və ya .silxg', None, 'Keçərli söhbətdə qarşılama mesajını silər.'
).add_info(
