...
CmdHelp('blacklist').add_command(
    'listblacklist',
    None,
    'Bir söhbətdə qara siyahıda olan sözləri göstərər.').add_command(
        'addblacklist',
        '<söz(lər)/cavab>',
        'Sözü qara siyahıya əlavə edər. \'Qara siyahı açar sözündə \' işlədildiyindən bot cavabı silər.',
        '.addblacklist amk').add_command(
            'rmblacklist',
            '<söz>',
            'İstifadə edilən qara siyahını dayandır.',
    '.rmblacklist amk').add_warning('Bu əməliyyatı həyata keçirtmək üçün admin olmalı və **Mesaj Silmə** icazəniz olmalıdır.').add()
