...
CmdHelp('covid19').add_command(
    'covid', '<ülke kodu>', 'Həm dünyada, həm də təqdim etdiyiniz ölkə üçün mövcud Covid 19 statistikası. Ölkəniz fərqlidirsə, onu əmrin yanına əlavə edin.',
    'covid az -> Azerbaycanı getirir.'
).add_warning('`Ölkə yazmasaz Azerbaycanı secər.`').add()
